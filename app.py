...
def predict():
    ...
    # print(y)
    if y<=257:
        message = "this car is in good condition"
    else:
        message = 'this car has high emmision of CO2'
    return render_template('next.html',j=a,k=b,l=c,m=d,n=e,o=f,p=g,q=h,r=i,x=y[0][0],resp=i,message=message)
